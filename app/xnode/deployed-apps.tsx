...
const Deployed_Apps = ({ services, setDeleteServiceOpen }: Deployed_Apps_Props) => {
  ...
  return (
    <div>
      <div className='flex justify-between items-center pb-2 pt-8 '>  <div className='text-[12px] font-[700] text-[#141414] xl:text-[16px] 2xl:text-[20px] 3xl:text-[24px] '>Apps({services.length})</div> <button onClick={() => { push('/app-store') }} className='border-[#525252] border-2 font-medium rounded-[12px] py-2 px-8 text-[#525252]'>+ Add App</button></div>
